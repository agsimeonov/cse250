...
AdaptedClientAGS.o: AdaptedClientAGS.cpp Deque2FlexIAGS.h StringWrap.h 
	$(CC) -c AdaptedClientAGS.cpp

AdaptedClientAGS: AdaptedClientAGS.o StringWrap.o
	$(CC) -o AdaptedClientAGS AdaptedClientAGS.o StringWrap.o $(LIBS)
